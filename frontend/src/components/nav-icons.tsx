...
export function DocsIcon() {
  return (
    <Svg>
      <path
        d="M12 6.2C10.6 4.9 8.6 4.2 6 4.2c-.9 0-1.73.08-2.5.25V18.2c.77-.17 1.6-.25 2.5-.25 2.6 0 4.6.68 6 2"
        fill="currentColor"
        fillOpacity={0.16}
        stroke="none"
      />
      <path d="M12 6.2C10.6 4.9 8.6 4.2 6 4.2c-.9 0-1.73.08-2.5.25V18.2c.77-.17 1.6-.25 2.5-.25 2.6 0 4.6.68 6 2V6.2Z" />
      <path d="M12 6.2c1.4-1.3 3.4-2 6-2 .9 0 1.73.08 2.5.25V18.2c-.77-.17-1.6-.25-2.5-.25-2.6 0-4.6.68-6 2V6.2Z" />
      <path d="M14.5 8.6c1-.4 2.2-.6 3.5-.6" />
      <path d="M14.5 11.6c1-.4 2.2-.6 3.5-.6" />
    </Svg>
  )
}
