...
| `014` | **Phase 2 — study child-run persistence + drill-down** | orchestrator writes each window/grid eval as a study-tagged run; study-detail ↔ run-detail; significance attaches to a window | Not started (next; closes the run/study seam) |
